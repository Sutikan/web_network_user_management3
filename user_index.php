														...
														$show_username = $show['username']; ?>
															<tr>
																...
																<td><?php 
																 ...
																 ?></td>
																<td>
																	<?php $showAcct = mysqli_query($con, "SELECT * FROM radacct WHERE username = '$username'");
																	$showA = mysqli_fetch_assoc($showAcct);
																	if ($showA) {
																		echo $showA['acctstarttime']; 
																	} else {
																		echo " - ";
																	}
																	?>
