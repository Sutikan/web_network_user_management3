...
<body>
	...
	<div class="navbar bg-white navbar-light d-block">
		<div class="container-fluid">
			<a href="<?php echo "user_index.php?id=$id" ?>" class="navbar-brand font-weight-bold text-secondary d-block d-md-none"><span class="badge badge-primary font-weight-bold px-2 py-1 mr-1">IT</span> CTC <span class="text-primary text-uppercase">Network</span></a>
